...
- Treat the stable retrievable content key as evidence-driven. Historical work suggests `content_id`, but Phase 01A–01C must reverify the current contract before collector code depends on it.
